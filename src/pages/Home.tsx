...
export const Home = () => {
  return (
    <div className="flex justify-between max-w-5xl mx-auto py-14 space-x-10">
      <div className="flex  flex-col gap-10">
        <div>
          ...
          <p className="max-w-xl mt-4">
            ...
            eos ipsam voluptas. Error minus sint nobis dolor laborum architecto,
            quaerat. Voluptatum porro expedita labore esse velit veniam laborum
